...
export function StatsStrip(props: { stats: UserStats }) {
  ...
  return (
    <section className="overflow-hidden rounded-[2rem] border border-[color:var(--line)] bg-[linear-gradient(180deg,rgba(255,255,255,0.68),rgba(245,240,228,0.78))] shadow-[0_18px_54px_rgba(21,34,27,0.08)]">
      ...
      <div className="grid gap-px bg-[color:var(--line)] sm:grid-cols-2 xl:grid-cols-3">
        {items.map((item) => (
          ...
          >
            ...
            <div className="mt-3 font-display text-5xl leading-none text-[color:var(--forest-strong)]">
              {item.value}
            </div>
          </div>
        ))}
