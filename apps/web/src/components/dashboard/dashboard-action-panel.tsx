...
export function DashboardActionPanel(props: {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden rounded-[2.75rem] border border-[#d7c2b9] bg-[#895032] px-6 py-7 text-[#faf9f6] shadow-sm sm:px-8 lg:px-10"
    >
      ...
      <div className="relative grid gap-6 lg:grid-cols-[1.35fr_0.65fr] lg:items-center">
        <div className="max-w-3xl">
          <h2 className="font-sans font-bold text-5xl leading-[0.95] text-[#faf9f6] sm:text-6xl">
            {title}
          </h2>
          <p className="mt-4 max-w-2xl text-base leading-7 text-[#faf9f6]/82 sm:text-lg">
            {description}
          </p>
          {summary ? (
            <div className="mt-4 text-sm uppercase tracking-[0.16em] text-[#faf9f6]/66">
              {summary}
            </div>
          ) : null}
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            {hasActivePlanning ? (
              <Link
                href="#recent-work"
                className="inline-flex min-h-12 items-center rounded-full bg-background[#faf9f6] px-5 text-sm font-semibold text-[#173224] shadow-[0_10px_30px_rgba(245,240,228,0.14)] transition hover:bg[#fffaf0]"
              >
                Continue planning
              </Link>
            ) : null}
            ...
            <Link
              ...
              className={`inline-flex min-h-12 items-center rounded-full px-5 text-sm font-semibold transition ${
                hasActivePlanning
                  ...
                  : "bg-[#faf9f6] text-[#173224] shadow-[0_10px_30px_rgba(245,240,228,0.14)] hover:bg-[#fffaf0]"
              }`}
            >
              Browse recipes
            </Link>
        ...
        <div className="flex justify-start lg:justify-end">
          <div className="flex h-32 w-32 items-center justify-center rounded-[2rem] border border-white/10 bg-white/6 text-[#faf9f6] shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] backdrop-blur-sm sm:h-40 sm:w-40">
            <div className="flex h-20 w-20 items-center justify-center rounded-full border border-white/12 bg-[#faf9f6]/10 font-sans font-bold text-4xl">
              M
            </div>
          </div>
        </div>
