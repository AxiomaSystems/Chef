        ...
        <div className="flex-1 flex flex-col items-center justify-center relative overflow-hidden">
          {error ? (
            <div className="text-center px-8 space-y-4">
              <span className="material-symbols-outlined text-[56px] text-white/40 block">
                no_photography
              </span>
            ...
            <div className="text-center px-8 space-y-4">
              ...
              <p className="text-white/60 text-sm">
                AI ingredient detection coming soon.
              </p>
              <button
                onClick={handleClose}
              ...
              <div className="bg-white rounded-2xl overflow-hidden">
                ...
                <div className="p-4 flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-outline/60 mt-1 font-mono">
                      {product.barcode}
                    </p>
                  </div>
                </div>
              ...
              {mode === "scan" && (
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  ...
                  <div className="relative w-72 h-44 z-10">
                    ...
                    <div
                      className="absolute left-2 right-2 h-0.5 bg-orange-400 animate-bounce"
                      style={{ top: "50%" }}
                    />
                  </div>
