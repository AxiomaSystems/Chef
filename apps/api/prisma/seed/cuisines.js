const cuisines = [
  ...
  {
    id: 'cuisine-south-asian',
    slug: 'south-asian',
    label: 'South Asian',
    kind: 'cultural',
  },
  {
    id: 'cuisine-southeast-asian',
...
async function resolveCuisineId(prisma, cuisineLabel) {
  const normalizedLabel =
    typeof cuisineLabel === 'string' ? cuisineLabel.trim() : '';
