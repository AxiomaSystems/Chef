...
const steps = [
  { title: "Who should Chef plan for?", subtitle: "Set the default serving context." },
  { title: "What food feels like you?", subtitle: "Cuisine and dietary defaults." },
  { title: "What should Chef reach for first?", subtitle: "Soft taste preferences." },
  { title: "What should Chef avoid?", subtitle: "Dislikes for recipe ranking." },
  { title: "Your kitchen reality", subtitle: "Equipment and constraints." },
  { title: "What should Chef optimize for?", subtitle: "Prioritized planning goals." },
  { title: "How do you shop?", subtitle: "Budget and store defaults." },
  { title: "How should Chef help first?", subtitle: "Guide future agent behavior." },
  { title: "Where should Chef build your cart?", subtitle: "Store availability and cart accuracy." },
];
...
export default function OnboardingScreen() {
  ...
  async function finish() {
    ...
    const result = await saveOnboarding({
      preferences: {
        ...form,
        kids_profile: undefined,
        spice_level: undefined,
        cooking_skill_level: undefined,
        preferred_cooking_time: undefined,
        typical_meal_times: [],
        calorie_tracking_mode: undefined,
        weekly_budget: undefined,
        shopping_mode: undefined,
        biggest_cooking_frustration: undefined,
        shopping_location: {
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {memoryItems.length > 0 ? (
          <View style={styles.memory}>
            <Text style={styles.groupTitle}>Chef will remember</Text>
